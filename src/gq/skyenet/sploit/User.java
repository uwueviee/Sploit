...
public class User {
    ...
    static JSONObject loadUser(String name, String password) {
        try {
            String fileContent = Files.readString(Paths.get(System.getProperty("user.home") + "/.sploit/" + name + ".sploit"));
    ...
    static JSONObject createUser(String name, String password) {
        try {
            new File(System.getProperty("user.home") + "/.sploit/").mkdirs();
            FileWriter write = new FileWriter((System.getProperty("user.home") + "/.sploit/" + name + ".sploit"));
